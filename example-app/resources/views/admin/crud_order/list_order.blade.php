...
@endif
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ number_format($orders->where('status', 'completed')->sum('total_price'), 0, ',', '.') }} đ</h3>
                <p>Tổng doanh thu</p>
            </div>
    ...
    <div class="controls">
        ...
        <select class="filter-select" onchange="window.location.href='?status='+this.value">
            ...
            <option value="processing" {{ $statusFilter == 'processing' ? 'selected' : '' }}>Chờ xử lý</option>
    ...
    <div class="table-container">
                ...
                <tr>
                    ...
                    <td>
                        <div class="customer-info">
                            <div class="customer-avatar">{{ strtoupper(substr($order->user->username ?? 'KH', 0, 2)) }}
                            </div>
                            <div class="customer-name">{{ $order->user->username ?? 'Khách hàng' }}</div>
                        </div>
                    </td>
                    ...
                    <td class="order-total">{{ number_format($order->total_price,  0, ',', '.') }} đ</td>
                    <td>
                        <div class="actions">
                            <a href="{{ route('order.show', $order->id) }}" class="action-btn btn-view">
        ...
        <div class="pagination">
            <div class="pagination-info">
                Hiển thị {{ $orders->firstItem() }}-{{ $orders->lastItem() }} của {{ $orders->total() }} kết quả
            </div>
