                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <div class="d-flex align-items-center justify-content-md-center">
                                    ...
                                    <input type="number" class="form-control quantity-input" value="{{ $item->soluong }}"
                                        min="1" data-user-id="{{ $item->id_user }}" data-product-id="{{ $item->id_product }}"
                ...
                <div class="summary-card p-4">
                    ...
                    <div class="d-flex justify-content-between fw-bold fs-5 mb-3">
                        ...
                        <span class="text-primary" id="grand-total">
                            {{ number_format($cartItems->sum(fn($item) => $item->product->price * $item->soluong) + 30000, 0, ',', '.') }}
                            ₫
                        </span>
                    </div>
