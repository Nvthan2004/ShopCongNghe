                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    placeholder="Nhập họ" value="{{ old('firstName') }}" required>
                                @error('firstName')
                                ...
                                <div class="col-md-6">
                                    ...
                                    placeholder="Nhập tên" value="{{ old('lastName') }}" required>
                                @error('lastName')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                                </div>
                                <div class="col-12">
                                    ...
                                    placeholder="your.email@example.com" value="{{ old('email', $user->email) }}" required>
                                @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                                </div>
                                <div class="col-md-6">
                                   ...
                                   <input type="tel" class="form-control" id="phone" name="phone"
                                    placeholder="0123 456 789" value="{{ old('phone') }}" required>
                                @error('phone')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                                </div>
                    ...
                    <div class="card-body p-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <img src="{{ asset('storage/' . $cart->product->image) }}"
                                                    alt="{{ $cart->product->name }}" class="product-img">
                                                <div>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-light text-dark">{{ $cart->soluong }}</span>
                                        </td>
                                        <td class="text-end price-text">
                                            {{ number_format($cart->product->price * $cart->soluong, 0, ',', '.') }}₫
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="total-section">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="total-amount text-primary">{{ number_format($totalPrice, 0, ',', '.') }}₫</span>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const form = document.querySelector('form[action="{{ route('order.store') }}"]');
