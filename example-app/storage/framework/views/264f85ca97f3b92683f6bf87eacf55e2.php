...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('user.list')); ?>">Trang Chủ</a>
...
</html><?php /**PATH D:\ĐỒ ÁN BACKEND2\ShopCongNghe\example-app\resources\views/dashboard.blade.php ENDPATH**/ ?>